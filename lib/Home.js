...
function Home(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(head_1.default, { children: (0, jsx_runtime_1.jsx)("title", { children: props.themeConfig.title }, void 0) }, void 0), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "container mx-auto max-w-2xl  px-4 sm:px-0 relative bg-slate-50/90 dark:bg-slate-600/90" }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: "text-3xl font-bold mb-4 sticky top-0 py-3 flex items-center text-slate-900 dark:text-slate-200 bg-slate-50/90 dark:bg-slate-600/90 backdrop-blur-sm " }, { children: props.themeConfig.title }), void 0), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "mt-2 mb-8" }, { children: (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "flex gap-2 dark:text-gray-400" }, { children: (_a = props.themeConfig.links) === null || _a === void 0 ? void 0 : _a.map((link, index) => {
                            ...
                            }) }), void 0) }), void 0), (0, jsx_runtime_1.jsx)("div", { children: props.posts.map(post => {
