...
function Post(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)(head_1.default, { children: [(0, jsx_runtime_1.jsxs)("title", { children: [props.post.title, " - ", props.themeConfig.title] }, void 0), (0, jsx_runtime_1.jsx)(OpenGraph_1.OpenGraph, { post: props.post }, void 0)] }, void 0), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "container mx-auto  max-w-2xl px-4 sm:px-0 relative bg-slate-50/90 dark:bg-slate-600/90" }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: 'sticky top-0 py-3 flex items-center text-slate-900 dark:text-slate-200 bg-slate-50/90 dark:bg-slate-600/90 backdrop-blur-sm' }, { children: (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "flex text-2xl font-bold mb-4 " }, { children: (0, jsx_runtime_1.jsx)(link_1.default, Object.assign({ href: "/" }, { children: props.themeConfig.title }), void 0) }), void 0) }), void 0), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "mb-8" }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: 'text-3xl font-medium dark:text-gray-400' }, { children: props.post.title }), void 0), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: 'flex mt-4 items-center gap-2 dark:text-gray-400' }, { children: [(0, jsx_runtime_1.jsx)("img", { className: 'w-8 h-8 rounded-full', src: props.post.author.avatarUrl }, void 0), (0, jsx_runtime_1.jsx)("a", Object.assign({ target: '_blank', href: props.post.author.url }, { children: props.post.author.login }), void 0), (0, jsx_runtime_1.jsx)("a", Object.assign({ className: 'underline text-sm', target: '_blank', href: props.post.url }, { children: "View on GitHub" }), void 0)] }), void 0), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: 'my-8' }, { children: (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: 'flex gap-4 flex-wrap' }, { children: [props.post.reactionGroups.filter(group => group.reactors.totalCount !== 0).map(reactionGroup => {
                                            ...
                                            return (label.name !== 'published' ? (0, jsx_runtime_1.jsx)("a", Object.assign({ href: label.url, target: "_blank" }, { children: (0, jsx_runtime_1.jsx)("div", Object.assign({ className: 'flex gap-2 border border-blue-100 px-4 py-1 rounded-full items-center', style: { backgroundColor: "#" + label.color } }, { children: (0, jsx_runtime_1.jsx)("span", Object.assign({ className: 'text-md' }, { children: label.name }), void 0) }), void 0) }), void 0) : null);
                                        })] }), void 0) }), void 0)] }), void 0), (0, jsx_runtime_1.jsx)("div", { className: "post-body dark:text-gray-400", dangerouslySetInnerHTML: { __html: props.post.html } }, void 0), (0, jsx_runtime_1.jsx)("hr", { className: 'my-12' }, void 0), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "font-sans" }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: 'mb-12' }, { children: (0, jsx_runtime_1.jsx)("a", Object.assign({ target: '_blank', href: props.post.url, className: 'font-medium border border-gray-700 hover:bg-gray-700 hover:text-gray-100 transition-all text-gray-700 text-sm rounded px-4 py-2' }, { children: "Add comment" }), void 0) }), void 0), props.post.comments.nodes.map(comment => {
